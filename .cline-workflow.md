...
gh release create vX.Y.Z linkahest-debug-X.Y.Z.apk --title "vX.Y.Z - Description" --notes "Changes description" --prerelease
...
## Testing Checklist:
- [ ] Share functionality works from various apps
- [ ] All transformation options appear correctly
- [ ] URLs are properly transformed
- [ ] Dark/light mode compatibility
- [ ] Eink display readability
- [ ] No crashes or ANRs
